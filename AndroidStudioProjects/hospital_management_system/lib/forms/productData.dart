...
import 'package:hospital_management_system/models/productData.dart';
...
class ProductDataForm extends StatefulWidget {
  final ProductData initialProductData;
  const ProductDataForm({Key? key, required this.initialProductData}) : super(key: key);

  @override
  State<ProductDataForm> createState() => ProductDataFormState();
}

class ProductDataFormState extends State<ProductDataForm> {
  ...
  void initState() {
    ...
    totalController.value = TextEditingValue(
      text: widget.initialProductData.total,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialProductData.total.length),
      ),
    );
    dateController.value = TextEditingValue(
      text: widget.initialProductData.date,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialProductData.date.length),
      ),
    );
    referenceController.value = TextEditingValue(
      text: widget.initialProductData.reference,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialProductData.reference.length),
      ),
    );
    vendeurController.value = TextEditingValue(
      text: widget.initialProductData.vendeur,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialProductData.vendeur.length),
      ),
    );
  }
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  enabled: widget.initialProductData.reference.isNotEmpty ? false : true,
                  decoration: InputDecoration(
                    border: InputBorder.none,
