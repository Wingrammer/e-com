...
class OtherEnrtyForm extends StatefulWidget {
  final OtherEnrty initialOtherEnrty;
  const OtherEnrtyForm({Key? key, required this.initialOtherEnrty}) : super(key: key);

  @override
  State<OtherEnrtyForm> createState() => OtherEnrtyFormState();
}

class OtherEnrtyFormState extends State<OtherEnrtyForm> {
  ...
  void initState() {
    ...
    totalController.value = TextEditingValue(
      text: widget.initialOtherEnrty.total,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialOtherEnrty.total.length),
      ),
    );
    dateController.value = TextEditingValue(
      text: widget.initialOtherEnrty.date,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialOtherEnrty.date.length),
      ),
    );
    referenceController.value = TextEditingValue(
      text: widget.initialOtherEnrty.reference,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialOtherEnrty.reference.length),
      ),
    );
    vendeurController.value = TextEditingValue(
      text: widget.initialOtherEnrty.vendeur,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialOtherEnrty.vendeur.length),
      ),
    );
  }
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  enabled: widget.initialOtherEnrty.reference.isNotEmpty ? false : true,
                  decoration: InputDecoration(
                    border: InputBorder.none,
