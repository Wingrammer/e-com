...
class ProductOutingForm extends StatefulWidget {
  final ProductOuting initialProductOuting;
  const ProductOutingForm({Key? key, required this.initialProductOuting}) : super(key: key);

  @override
  State<ProductOutingForm> createState() => ProductOutingFormState();
}

class ProductOutingFormState extends State<ProductOutingForm> {
  ...
  void initState() {
    ...
    totalController.value = TextEditingValue(
      text: widget.initialProductOuting.total,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialProductOuting.total.length),
      ),
    );
    dateController.value = TextEditingValue(
      text: widget.initialProductOuting.date,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialProductOuting.date.length),
      ),
    );
    referenceController.value = TextEditingValue(
      text: widget.initialProductOuting.reference,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialProductOuting.reference.length),
      ),
    );
    vendeurController.value = TextEditingValue(
      text: widget.initialProductOuting.vendeur,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialProductOuting.vendeur.length),
      ),
    );
  }
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  enabled: widget.initialProductOuting.reference.isNotEmpty ? false : true,
                  decoration: InputDecoration(
                    border: InputBorder.none,
