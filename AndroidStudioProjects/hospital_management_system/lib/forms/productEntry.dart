...
class ProductEntryForm extends StatefulWidget {
  final ProductEntry initialProductEntry;
  const ProductEntryForm({Key? key, required this.initialProductEntry}) : super(key: key);

  @override
  State<ProductEntryForm> createState() => ProductEntryFormState();
}

class ProductEntryFormState extends State<ProductEntryForm> {
  ...
  void initState() {
    ...
    totalController.value = TextEditingValue(
      text: widget.initialProductEntry.total,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialProductEntry.total.length),
      ),
    );
    dateController.value = TextEditingValue(
      text: widget.initialProductEntry.date,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialProductEntry.date.length),
      ),
    );
    referenceController.value = TextEditingValue(
      text: widget.initialProductEntry.reference,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialProductEntry.reference.length),
      ),
    );
    vendeurController.value = TextEditingValue(
      text: widget.initialProductEntry.vendeur,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialProductEntry.vendeur.length),
      ),
    );
  }
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  enabled: widget.initialProductEntry.reference.isNotEmpty ? false : true,
                  decoration: InputDecoration(
                    border: InputBorder.none,
