...
class IncomeForm extends StatefulWidget {
  ...
  const IncomeForm({Key? key, required this.initialIncome}) : super(key: key);
...
class IncomeFormState extends State<IncomeForm> {
  ...
  void initState() {
    ...
    totalController.value = TextEditingValue(
      text: '${widget.initialIncome.total}',
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialIncome.total!.length),
      ),
    );
    dateController.value = TextEditingValue(
      text: '${widget.initialIncome.date}',
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialIncome.date!.length),
      ),
    );
    referenceController.value = TextEditingValue(
      text: '${widget.initialIncome.reference}',
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialIncome.reference!.length),
      ),
    );
    vendeurController.value = TextEditingValue(
      text: '${widget.initialIncome.patient}',
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialIncome.patient!.length),
      ),
    );
  }
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  enabled: widget.initialIncome.reference!.isNotEmpty ? false : true,
                  decoration: InputDecoration(
                    border: InputBorder.none,
