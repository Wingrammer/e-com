...
class ServiceForm extends StatefulWidget {
  ...
  const ServiceForm({Key? key, required this.initialService}) : super(key: key);
...
class ServiceFormState extends State<ServiceForm> {
  ...
  void initState() {
    ...
    totalController.value = TextEditingValue(
      text: widget.initialService.total,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialService.total.length),
      ),
    );
    dateController.value = TextEditingValue(
      text: widget.initialService.date,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialService.date.length),
      ),
    );
    referenceController.value = TextEditingValue(
      text: widget.initialService.reference,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialService.reference.length),
      ),
    );
    vendeurController.value = TextEditingValue(
      text: widget.initialService.vendeur,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialService.vendeur.length),
      ),
    );
  }
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  enabled: widget.initialService.reference.isNotEmpty ? false : true,
                  decoration: InputDecoration(
                    border: InputBorder.none,
