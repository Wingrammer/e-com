...
import 'package:hospital_management_system/models/patientInvoiveItem.dart';
import 'package:hospital_management_system/style/colors.dart';
import 'package:hospital_management_system/style/style.dart';

class PatientInvoiceItemForm extends StatefulWidget {
  final PatientInvoiceItem initialPatientInvoiceItem;
  const PatientInvoiceItemForm({Key? key, required this.initialPatientInvoiceItem}) : super(key: key);

  @override
  State<PatientInvoiceItemForm> createState() => PatientInvoiceItemFormState();
}

class PatientInvoiceItemFormState extends State<PatientInvoiceItemForm> {
  ...
  void initState() {
    ...
    totalController.value = TextEditingValue(
      text: widget.initialPatientInvoiceItem.total,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialPatientInvoiceItem.total.length),
      ),
    );
    dateController.value = TextEditingValue(
      text: widget.initialPatientInvoiceItem.date,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialPatientInvoiceItem.date.length),
      ),
    );
    referenceController.value = TextEditingValue(
      text: widget.initialPatientInvoiceItem.reference,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialPatientInvoiceItem.reference.length),
      ),
    );
    vendeurController.value = TextEditingValue(
      text: widget.initialPatientInvoiceItem.vendeur,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialPatientInvoiceItem.vendeur.length),
      ),
    );
  }
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  enabled: widget.initialPatientInvoiceItem.reference.isNotEmpty ? false : true,
                  decoration: InputDecoration(
                    border: InputBorder.none,
