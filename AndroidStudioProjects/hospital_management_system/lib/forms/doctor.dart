...
class DoctorForm extends StatefulWidget {
  ...
  const DoctorForm({Key? key, required this.initialDoctor}) : super(key: key);

  @override
  State<DoctorForm> createState() => DoctorFormState();
}
...
class DoctorFormState extends State<DoctorForm> {
  ...
  void initState() {
    ...
    totalController.value = TextEditingValue(
      text: widget.initialDoctor.total,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialDoctor.total.length),
      ),
    );
    dateController.value = TextEditingValue(
      text: widget.initialDoctor.date,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialDoctor.date.length),
      ),
    );
    referenceController.value = TextEditingValue(
      text: widget.initialDoctor.reference,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialDoctor.reference.length),
      ),
    );
    vendeurController.value = TextEditingValue(
      text: widget.initialDoctor.vendeur,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialDoctor.vendeur.length),
      ),
    );
  }
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  enabled: widget.initialDoctor.reference.isNotEmpty ? false : true,
                  decoration: InputDecoration(
                    border: InputBorder.none,
