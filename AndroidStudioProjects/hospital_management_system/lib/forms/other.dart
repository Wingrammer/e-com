...
class OtherForm extends StatefulWidget {
  final Other initialOther;
  const OtherForm({Key? key, required this.initialOther}) : super(key: key);
...
class OtherFormState extends State<OtherForm> {
  ...
  void initState() {
    ...
    totalController.value = TextEditingValue(
      text: widget.initialOther.total,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialOther.total.length),
      ),
    );
    dateController.value = TextEditingValue(
      text: widget.initialOther.date,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialOther.date.length),
      ),
    );
    referenceController.value = TextEditingValue(
      text: widget.initialOther.reference,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialOther.reference.length),
      ),
    );
    vendeurController.value = TextEditingValue(
      text: widget.initialOther.vendeur,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialOther.vendeur.length),
      ),
    );
  }
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  enabled: widget.initialOther.reference.isNotEmpty ? false : true,
                  decoration: InputDecoration(
                    border: InputBorder.none,
