...
class InvoiceForm extends StatefulWidget {
  ...
  const InvoiceForm({Key? key, required this.initialInvoice}) : super(key: key);
...
class InvoiceFormState extends State<InvoiceForm> {
  ...
  void initState() {
    ...
    totalController.value = TextEditingValue(
      text: widget.initialInvoice.total,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialInvoice.total.length),
      ),
    );
    dateController.value = TextEditingValue(
      text: widget.initialInvoice.date,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialInvoice.date.length),
      ),
    );
    referenceController.value = TextEditingValue(
      text: widget.initialInvoice.reference,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialInvoice.reference.length),
      ),
    );
    vendeurController.value = TextEditingValue(
      text: widget.initialInvoice.vendeur,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialInvoice.vendeur.length),
      ),
    );
  }
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  enabled: widget.initialInvoice.reference.isNotEmpty ? false : true,
                  decoration: InputDecoration(
                    border: InputBorder.none,
