...
import 'package:hospital_management_system/models/tests.dart';
...
class TextForm extends StatefulWidget {
  ...
  const TextForm({Key? key, required this.initialText}) : super(key: key);
...
class TextFormState extends State<TextForm> {
  ...
  void initState() {
    ...
    totalController.value = TextEditingValue(
      text: widget.initialText.total,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialText.total.length),
      ),
    );
    dateController.value = TextEditingValue(
      text: widget.initialText.date,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialText.date.length),
      ),
    );
    referenceController.value = TextEditingValue(
      text: widget.initialText.reference,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialText.reference.length),
      ),
    );
    vendeurController.value = TextEditingValue(
      text: widget.initialText.vendeur,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialText.vendeur.length),
      ),
    );
  }
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  enabled: widget.initialText.reference.isNotEmpty ? false : true,
                  decoration: InputDecoration(
                    border: InputBorder.none,
