...
class OtherOutingForm extends StatefulWidget {
  final OtherOuting initialOtherOuting;
  const OtherOutingForm({Key? key, required this.initialOtherOuting}) : super(key: key);

  @override
  State<OtherOutingForm> createState() => OtherOutingFormState();
}

class OtherOutingFormState extends State<OtherOutingForm> {
  ...
  void initState() {
    ...
    totalController.value = TextEditingValue(
      text: widget.initialOtherOuting.total,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialOtherOuting.total.length),
      ),
    );
    dateController.value = TextEditingValue(
      text: widget.initialOtherOuting.date,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialOtherOuting.date.length),
      ),
    );
    referenceController.value = TextEditingValue(
      text: widget.initialOtherOuting.reference,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialOtherOuting.reference.length),
      ),
    );
    vendeurController.value = TextEditingValue(
      text: widget.initialOtherOuting.vendeur,
      selection: TextSelection.fromPosition(
        TextPosition(offset: widget.initialOtherOuting.vendeur.length),
      ),
    );
  }
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  enabled: widget.initialOtherOuting.reference.isNotEmpty ? false : true,
                  decoration: InputDecoration(
                    border: InputBorder.none,
